...
# iterations
#per_epoch_iteration = 1000 (This was the original number of epochs but it was causing training to be long)
...
class Loss_MRAE(nn.Module):
    def forward(self, output, target):
        ...
        mrae = torch.mean(error.reshape(-1))  # Changed .() to .reshape()
        return mrae
